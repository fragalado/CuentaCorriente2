...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// Creamos una lista que contendrá los objetos de tipo CuentaCorriente (base de
		// datos)
		...
		do {
			...
			switch (opcion) {
				case 1:
					...
					// Pasamos los valores como parametros a crearCuenta y la cuenta creada la
				...
				case 0:
					...
					break;
				default:
					System.err.println("** Error: El valor introducido no es correcto **");
					break;
			}
